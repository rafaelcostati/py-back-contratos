...
def create():
    ...
    # Validações dos campos obrigatórios e chaves estrangeiras
...
def list_all():
    # Pega os parâmetros da URL, por exemplo: /contratos?gestor_id=1
    filters = {
        'gestor_id': request.args.get('gestor_id'),
        'fiscal_id': request.args.get('fiscal_id')
    }
    # Remove filtros que não foram passados
